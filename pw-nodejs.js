...
const OUTPUT_FILE = 'playwright-nodejs-docs-for-llm.md';

async function getLinks(page) {
    await page.waitForSelector("nav[aria-label='Docs sidebar']");

    await page.locator("//a[normalize-space()='Migration']").click();
...
async function main() {
    ...
    try {
        ...
        await appendToFile(`# THIS DOCUMENT CONTAINS THE COMPLETE DOCUMENTATION FOR PLAYWRIGHT NODEJS.\n\n`);
